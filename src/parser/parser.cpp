...
parser::parser(std::vector<lexer::Token*>& toks, unsigned long long int _size, const char* _srcf) {
...
bool parser::main() {
    for (; i < size; ) i = dcl(i, root);
    return error;
}

unsigned long long int parser::import(unsigned long long int i, Node*& parent) {
...
unsigned long long int parser::dcl(unsigned long long int i, Node*& parent) {
...
unsigned long long int parser::vardcl(unsigned long long int i, Node*& parent) {
    unsigned long long int j = i;
    Node* node = new Node();
...
unsigned long long int parser::enumdcl(unsigned long long int i, Node*& parent) {
    unsigned long long int j = i + 1;
    Node* node = new Node();
...
unsigned long long int parser::fndcl(unsigned long long int i, Node*& parent, bool body) {
    unsigned long long int j = i + 1;
    Node* node = new Node();
...
unsigned long long int parser::type(unsigned long long int i, Node*& parent) {
    unsigned long long int j = i;
    Node* node = new Node();
    parent->child.push_back(node);
    node->type = Type;
...
unsigned long long int parser::classdcl(unsigned long long int i, Node*& parent) {
    unsigned long long int j = i + 1;
    Node* node = new Node();
...
unsigned long long int parser::stmt_body(unsigned long long int i, Node*& parent) {
    unsigned long long int j = i + 1;
    bool stmt_end = false;
    Node* node = new Node();
...
unsigned long long int parser::stmt(unsigned long long int i, Node*& node) {
    unsigned long long int j = i;
...
unsigned long long int parser::expr(unsigned long long int i, Node*& parent) {
    this->i = i;
    Node* expr_ = pratt(0);
...
Node* parser::pratt(unsigned int rbp) {
    Node* left = nud();
    if (left->value == "match") {
        delete left;
        left = match();
...
// Utils
unsigned int parser::GetBindingPower(std::string right) {
    for (auto& op : optable) {
...
bool parser::IsRightBinding(std::string right) {
    for (auto& op : optable) {
